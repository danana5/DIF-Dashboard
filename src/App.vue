...
<v-app id="inspire">
    <v-navigation-drawer v-model="drawer" color="blue-grey darken-4" app>
        ...
        <v-list dense nav>
            ...
            <v-list-item class="mt-3">
                <v-textarea label="Notes" class="white--text" color="white" outlined dark background-color="blue-grey darken-3" no-resize rounded>
                </v-textarea>
            </v-list-item>
            <v-divider></v-divider>
    ...
    <v-app-bar app color="blue darken-3" extended>
        ...
        <v-toolbar-title>
            <router-link to="/dash"><img src="./assets/logo.png" alt="DIF Logo" height="90%" width="90%" style="margin-top: 30px"></router-link>
        </v-toolbar-title>
    </v-app-bar>
